...
To use this chat POC, you first have to launch the backend using the main function in the PocApplication.java file.

## Running frontend

To launch the frontend, go to frontend folder (`cd frontend`) then use :
